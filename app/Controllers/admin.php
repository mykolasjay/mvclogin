...
class Admin extends BaseController
{
    ...
    // patikrinam ar sesija prasidejus per clase session ir metoda public static function get($key)
        }
        ...
        if (isset($_POST['submit'])) {
           ...
           $email = (isset($_POST['email']) ? $_POST['email'] : null);
            ...
            if (count($errors) == 0) {
                ...
                $mail->Body    = "<p>To change your password please click <a href='http://localhost:8080/admin/change_password/$token'>this link</a></p>";
                $mail->AltBody = "To change your password please go to this address: http://localhost:8080/admin/change_password/$token";
                $mail->send();
