...
/*Users modelis skirtas paimti informacija is db, kaip tai daroma:
BaseModel metodas kreipiasi i database\\helper clase, database klase pasiima prisijungimus is config failo ir prisijungia prie db, tada users clase naudoja db->select metodus paimti duomenis is db ir issaugoti juos kintamuosiuose*/
